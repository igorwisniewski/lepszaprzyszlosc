            ...
            <main className="bg-white py-16 sm:py-24 text-black">
                ...
                <div className="mx-auto max-w-3xl px-6 lg:px-8">
                    ...
                    <p className="mt-6 text-xl leading-8 text-gray-600">
                        Twoja prywatność jest dla nas priorytetem. Poniżej wyjaśniamy, jakie dane zbieramy i jak je chronimy w serwisie <strong>Fundacja Lepsza Przyszłość</strong>.
                    </p>
                    ...
                    <div className="prose prose-lg prose-gray mt-14">
                        ...
                        <p>
                            Niniejsza Polityka Prywatności określa zasady przetwarzania i ochrony danych osobowych przekazanych przez Użytkowników w związku z korzystaniem przez nich z usług serwisu <strong>Fundacja Lepsza Przyszłość</strong> (dalej jako &#34;Serwis&#34;).
                        </p>
                        ...
                        <div className="my-6 rounded-lg border border-amber-300 bg-amber-50 p-6 not-prose">
                            ...
                            <dl className="mt-4 space-y-3 text-base text-amber-800">
                                <div className="grid grid-cols-1 gap-1 sm:grid-cols-4 sm:gap-4">
                                    ...
                                    <dd className="sm:col-span-3">Fundacja Lepsza Przyszłość Aleksander Czajkowski</dd>
                                </div>
                                <div className="grid grid-cols-1 gap-1 sm:grid-cols-4 sm:gap-4">
                                    <dt className="font-medium text-amber-900">Adres:</dt>
                                    <dd className="sm:col-span-3">ul. Zielony Trójkąt 4E/8
                                        80-869 Gdańsk</dd>
                                </div>
                                <div className="grid grid-cols-1 gap-1 sm:grid-cols-4 sm:gap-4">
                                    <dt className="font-medium text-amber-900">E-mail:</dt>
                                    <dd className="sm:col-span-3">
                                        <a href="mailto:lepszaprzyszlosc@op.pl" className="font-medium text-amber-900 underline hover:text-amber-700">
                                            lepszaprzyszlosc@op.pl
                                        </a>
                                    </dd>
                                </div>
                                <div className="grid grid-cols-1 gap-1 sm:grid-cols-4 sm:gap-4">
                                    <dt className="font-medium text-amber-900">NIP:</dt>
                                    <dd className="sm:col-span-3">9571186907</dd>
                                </div>
                                <div className="grid grid-cols-1 gap-1 sm:grid-cols-4 sm:gap-4">
                                    <dt className="font-medium text-amber-900">REGON:</dt>
                                    <dd className="sm:col-span-3">541431110</dd>
                                </div>
                                <div className="grid grid-cols-1 gap-1 sm:grid-cols-4 sm:gap-4">
                                    <dt className="font-medium text-amber-900">Telefon:</dt>
                                    <dd className="sm:col-span-3">+48 784 719 026</dd>
                                </div>
                            </dl>
                        </div>
                        ...
                        <p>W sprawach związanych z danymi osobowymi prosimy o kontakt pod adresem e-mail: <a href="mailto:lepszaprzyszlosc@op.pl" className="font-semibold text-sky-600 hover:text-sky-500">lepszaprzyszlosc@op.pl</a>.</p>
                    </div>
